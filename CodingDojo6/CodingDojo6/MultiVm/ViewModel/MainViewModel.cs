...
namespace CodingDojo6.ViewModel
{
    ...
    {
        private ItemVm _currentItem;
        
        public ObservableCollection<ItemVm> Items { get; set; }
        public ObservableCollection<ItemVm> Cart { get; set; }
        private RelayCommand<ItemVm> _buyBtnClickedCmd;
        ...
        {
            get => _buyBtnClickedCmd;
            set
            {
                _buyBtnClickedCmd = value;
                RaisePropertyChanged();
            }
        }
        ...
        public MainViewModel()
        {
            ...
            BuyBtnClickedCmd = new RelayCommand<ItemVm>(product =>
           {
               Cart.Add(product);
           },
            p => { return true; }
